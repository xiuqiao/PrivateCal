...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    if([kind isEqualToString:UICollectionElementKindSectionHeader]){
        ...
        [header.deletePhotoButton addTarget:self action:@selector(deletePhotosButtonClick:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)deletePhotosButtonClick:(UIButton *)btn{
...
//       [NSTimer scheduledTimerWithTimeInterval:0.5 target:self selector:@selector(loadImageFinished) userInfo:nil repeats:YES];
...
//{
//    if(_imagesArr.count > num){
//    NSString *imagePath = _imagesArr[num];
//  UIImage *image = [UIImage imageWithContentsOfFile:imagePath];
//
